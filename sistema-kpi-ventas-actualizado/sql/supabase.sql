...
begin
  ...
  insert into public.usuarios (id, usuario, email, nombre, rol_id, jefe_id, codigo_operativo, activo)
  values (auth_id, lower(p_usuario), lower(p_email), p_nombre, gerente_role_id, null, null, true)
  on conflict (id) do update set
    usuario = excluded.usuario,
    email = excluded.email,
    nombre = excluded.nombre,
...
begin
  ...
  insert into public.usuarios (id, usuario, email, nombre, rol_id, jefe_id, codigo_operativo, activo)
  values (auth_id, lower(p_usuario), lower(p_email), trim(p_nombre), jefe_role_id, null, codigo, true)
  on conflict (id) do update set
    usuario = excluded.usuario,
    email = excluded.email,
    nombre = excluded.nombre,
